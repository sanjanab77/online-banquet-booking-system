...
if($query -> rowCount() == 0)
{
   // $sql="INSERT INTO `tbladmin` ( `AdminName`,`UserName`,`MobileNumber`,`Email`,`Password`)Values(:ad_name,:fname,:mobno,:email,:password)""
$sql="Insert Into tbladmin(AdminName,UserName,MobileNumber,Email,Password)Values(:aname,:fname,:mobno,:email,:password)";
...
<?php
    ...
    <section class="register" id="register">
        ...
        <h1 class="heading"> REGISTER for <span>Admin</span></h1>

        <form method="post" name="signup" onsubmit="return checkpass();">
            <div class="inputBox">
                <input type="text" name="aname" placeholder="Admin Name" required="true">
